...
export default async function Cart() {
  ...
  return (
    <>
      <Navbar page={2} />
      <main className="bg-slate-100 w-screen min-h-screen overflow-x-hidden flex">
        <section className="flex flex-col gap-5 items-center pt-12 justify-start w-screen md:w-2/3 h-auto bg-stone-200 overflow-x-hidden px-4 md:px-10 pb-20">
